              ...
              "string" === e.type(n.mask) &&
                ...
                t.on("keydown.xdsoft", function (i) {
                  ...
                  if (
                    ...
                    (-1 !== [b, w, _, x, S].indexOf(l) && E) ||
                    -1 !== [p, f, g, h, m, y, d, v, u].indexOf(l)
                  )
                    return !0;
                  return (i.preventDefault(), !1);
                })));
...
var Swiper = (function () {
          ...
          for (let t = 0, n = i.length; t < n; t += 1) {
            ...
            void 0 !== r &&
              ...
              (d(e[n]) && d(s[n])
                ...
                : !d(e[n]) && d(s[n])
                  ? ((e[n] = {}),
                    s[n].__swiper__ ? (e[n] = s[n]) : c(e[n], s[n]))
                  : (e[n] = s[n]));
          }
        }
      }
    ...
    function N(e) {
      ...
      if (c.preventedByNestedSwiper)
        return ((o.startX = h), void (o.startY = f));
      if (!i.allowTouchMove)
        return (
        ...
        e.params.createElements &&
          Object.keys(n).forEach((s) => {
            if (!i[s] && !0 === i.auto) {
              let r = f(e.el, `.${n[s]}`)[0];
              (r ||
                ((r = m("div", n[s])), (r.className = n[s]), e.el.append(r)),
                (i[s] = r),
                (t[s] = r));
            }
          }),
          ...
          setTranslate: () => {
            ...
            for (let i = 0; i < e.length; i += 1) {
              ...
              (d < 0
                ...
                p.forEach((e, t) => {
                  p[t] =
                    `calc(${e}px + (${s(m.translate[t])} * ${Math.abs(d * o)}))`;
                }),
                h.forEach((e, t) => {
